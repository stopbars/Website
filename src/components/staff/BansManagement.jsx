  ...
  const renderBanRow = (b, i) => {
    ...
    return (
      <tr key={`${targetId}-${i}`} className="border-b border-zinc-800 hover:bg-zinc-800/40">
        ...
        <td className="px-2 py-2 text-[15px] text-zinc-400">
        ...
        <td className="px-2 py-2 text-[15px]">
          <span
            className={`px-2 py-0.5 rounded text-xs ${isActive ? 'bg-red-500/10 text-red-400 border border-red-500/20' : 'bg-zinc-800 text-zinc-300 border border-zinc-700'}`}
          >
  ...
  return (
    <div className="container mx-auto px-4 pt-2 pb-4 max-w-4xl">
      ...
      <div className="space-y-7">
        {(error || success) && (
          <div
            className={`p-3 rounded border text-sm flex items-center gap-2 ${error ? 'bg-red-500/10 border-red-500/30 text-red-400' : 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400'}`}
          >
        ...
        <Card className="p-5">
          <h3 className="text-sm font-medium text-zinc-300 mb-4 flex items-center gap-2">
            <BanIcon className="w-4 h-4" /> Create / Update Ban
          </h3>
          ...
          <div className="flex gap-2 justify-end mt-5">
            <Button
              ...
              className="flex items-center justify-center gap-2 text-sm px-2 py-1.5"
            >
        ...
        <Card className="p-5">
          <h3 className="text-sm font-medium text-zinc-300 mb-4 flex items-center gap-2">
            <UserX className="w-4 h-4" /> Existing Bans
          </h3>
