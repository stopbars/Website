    ...
    <section className="py-24" id="support">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-zinc-300 mb-12 max-w-2xl">
          We&apos;re here to help you get the most out of BARS, join our community for support and
          updates.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="p-8">
            ...
            <p className="text-zinc-300 text-sm mb-6">
              Access comprehensive guides for installation, configuration, and usage for both pilots
              and controllers.
            </p>
            <Button
              variant="secondary"
          ...
          <Card className="p-8">
            ...
            <p className="text-zinc-300 text-sm mb-4">
              Found a bug? Report it through our Discord server or GitHub with detailed information
              to help us investigate.
            </p>
            <div className="p-2 bg-zinc-800/50 rounded-lg mb-4">
              <p className="text-xs text-zinc-300 mb-1">Remember to save your log files from:</p>
              <div className="flex items-center justify-between p-1.5 bg-zinc-800 rounded">
                <code className="font-mono text-emerald-400 text-xs">%localappdata%/BARS</code>
                <button
