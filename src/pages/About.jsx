    ...
    <Layout>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 pt-8 sm:pt-12 space-y-12 sm:space-y-16">
        ...
        <section className="text-center mb-8 sm:mb-12">
          <h1 className="text-5xl sm:text-5xl lg:text-6xl font-bold mb-4 text-white">About BARS</h1>
        </section>
        {/* What is BARS Section */}
        <section className="mb-6 sm:mb-8">
          <Card className="p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">
              What is <span className="text-red-500">BARS</span>?
            </h2>
            <p className="text-zinc-300 leading-relaxed mb-4 text-sm sm:text-base">
              BARS is a comprehensive airport lighting simulation platform that bridges the gap
              between flight simulators and virtual ATC environments. Our advanced system
              synchronizes real-time airport lighting states, including stopbars, follow-the-greens,
              gate lead-in lighting, and runway lead-on lights, from virtual controllers client,
              directly to the simulator, creating an never before seen level of airport lighting
              realism.
            </p>
            <p className="text-zinc-300 leading-relaxed text-sm sm:text-base">
              By leveraging SimConnect technology and establishing seamless connections with popular
              ATC clients like vatSys and EuroScope, BARS provides a never before seen level of
              realism for virtual controllers and pilots. BARS supports both default and third-party
              scenery, automatically adapting lighting positions to match your specific airport
              configurations.
            </p>
          </Card>
        </section>
          ...
          <div className="space-y-8">
            <Card className="p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Download and run the BARS Installer for easy management of all BARS updates with
                update detection, installation paths, setup, and more. Our custom installer handles
                all installation and configuration automatically.
              </p>
            </Card>
            ...
            <Card className="p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50">
              ...
              <p className="text-zinc-300 leading-relaxed">
                BARS communicates with your simulator and sends requests to the BARS Pilot Client
                via the Core backend server, with these requests it updates lighting in your
                simulator through SimConnect and SimObjects, functioning similarly to how popular
                add-ons like &quot;GSX&quot; work.
              </p>
            </Card>
            ...
            <Card className="p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Works with default, third-party, and custom scenery, automatically adapting lighting
                positions based on selection. You select your preferred scenery in the BARS Pilot
                Client, save your changes, then no need to restart your simulator as it will update
                lighting positions automatically.
              </p>
            </Card>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-6 bg-gradient-to-br from-red-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Authentic stopbar behavior with proper timing and visual feedback for realistic
                ground operations.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-yellow-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Directional stopbar control allowing for complex traffic flow management and
            ...
            <Card className="p-6 bg-gradient-to-br from-blue-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                High-quality 3D stopbar models with authentic lighting effects and proper visual
                representation.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-green-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Realistic Follow the Greens (FTG) system for guiding pilots around airports through
            ...
            <Card className="p-6 bg-gradient-to-br from-green-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Lead-on lights to the runway which are realistically displayed after stopbars are
                turned off at holding points.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-green-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Terminal gate lighting systems with precise positioning and timing for realistic
                gate operations.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-orange-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Instant synchronization between controllers and pilots simulators for realistic
                lighting operations.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-orange-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Integrated division management system for managing your division members, airports,
                lighting, and more.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-violet-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                Native vatSys and EuroScope plugins for seamless integration with existing ATC
                clients.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-rose-950/30 to-transparent transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <p className="text-zinc-400 text-sm">
                MSFS 2020 and 2024 integration through the BARS Pilot Client for stable simulator
                connectivity.
              </p>
            </Card>
            ...
            >
              ...
              <p className="text-zinc-400 text-sm">
                Community-driven development with transparent codebase and detailed contributing
                guides.
              </p>
            </Card>
          </div>
          ...
          <div className="mb-8 sm:mb-12">
            <Card className="p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-emerald-950/30 to-transparent">
              ...
              <p className="text-zinc-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                Help expand BARS through airport mapping and open-source development. Expand airport
                and scenery compatibility by mapping airport lighting profiles for your home airport
                or favorite facilities, expanding the number of BARS compatible airports.
              </p>
          ...
          <div className="mb-8 sm:mb-12">
            <Card className="p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-slate-950/30 to-transparent">
              ...
              <p className="text-zinc-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                ...
                Speed up development cycles and ship more features to the community.
              </p>
              <div className="grid grid-cols-1 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="flex items-center text-zinc-300 text-sm sm:text-base">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50 flex flex-col">
            <div className="flex-grow">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Find comprehensive setup guides, feature explanations, and troubleshooting
                information in our detailed documentation.
              </p>
            </div>
            <div className="mt-6">
              <Button
          ...
          <Card className="p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50 flex flex-col">
            <div className="flex-grow">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Need help? Our support team and community are here to assist you with any questions
                or issues you may encounter.
              </p>
            </div>
            <div className="mt-6">
              <Button onClick={() => (window.location.href = '/support')} className="w-full group">
                Get Support
                <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
        ...
        <section className="text-center">
          <Card className="p-8 bg-gradient-to-br from-zinc-900/80 to-zinc-900/40">
            ...
            <p className="text-zinc-300 mb-6">
              Connect with other BARS users, get support, view previews, and stay updated with the
              latest news and features.
            </p>
            <div className="flex justify-center">
              <Button
                onClick={() =>
                  window.open('https://discord.gg/7EhmtwKWzs', '_blank', 'noopener,noreferrer')
                }
