          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-0">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-base sm:text-lg md:text-xl text-zinc-300 max-w-2xl">
                Celebrating the amazing dedicated developers who volunteer their time and expertise
                to help contribute to BARS across all our GitHub repositories
              </p>
        ...
        <section className="text-center mt-16">
          <Card className="p-12 bg-zinc-900/60 border-red-500/30">
            ...
            <p className="text-zinc-300 mb-8 max-w-2xl mx-auto text-lg">
              ...
              expertise. Whether it&apos;s code, documentation, testing, or community support, every
