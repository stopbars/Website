...
export function buildGenerationDiagnostic({
  ...
  return {
    ...
    generation: {
      ...
      guidanceStopbarBoundaryTrims: output.guidanceStopbarBoundaryTrims,
      guidanceStopbarCrossingAudit: output.guidanceStopbarCrossingAudit,
      removalStopbarBoundaryTrims: output.removalStopbarBoundaryTrims,
      removalPerformance: output.removalPerformance,
      draftXml: output.xml,
...
function generationSummary(data, matching, output) {
  ...
  return {
    ...
    removalStopbarBoundaryTrims: output.removalStopbarBoundaryTrims?.length ?? 0,
    removalGenerationMilliseconds: output.removalPerformance?.totalMilliseconds,
